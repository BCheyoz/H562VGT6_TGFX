...
// C/C++ source code generated on : Thu Apr  3 17:11:41 2025
//
...
class SensErrorDetection final
{
 ...
 public:
  ...
  void step(const float *rtu_signalRaw, float *rty_signal, bool *rty_isDefect,
            float rtp_Cs_dflt_val, float rtp_Cs_op_scl_err_rst_time, float
            rtp_Cs_op_scl_err_set_time, float rtp_Cs_smpl_time, float
            rtp_Cs_sttc_err_rst_time, float rtp_Cs_sttc_err_rst_tol, float
            rtp_Cs_sttc_err_set_time, float rtp_Cs_val_max, float rtp_Cs_val_min,
            float rtp_Cs_var_err_rst_time, float rtp_Cs_var_err_set_time, float
            rtp_Cs_var_max);
