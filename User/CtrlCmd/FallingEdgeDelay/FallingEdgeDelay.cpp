...
// C/C++ source code generated on : Thu Jul 31 11:03:53 2025
//
...
void FallingEdgeDelay::step(const uint8_t *rtu_In, uint8_t *rty_Out, float
  rtp_Delay, float rtp_TimeStep)
{
