...
class InPutMng final
{
 ...
 public:
  ...
  struct DW_InPutMng_T {
    ...
    ta_pwr Cs_elec_htr_bstr_cnsp_prev_DSTA;// '<S6>/Cs_elec_htr_bstr_cnsp_prev'
    ta_pwr Cs_elec_htr_bstr_cnsp_prev_DS_g;// '<S8>/Cs_elec_htr_bstr_cnsp_prev'
  ...
  struct P_InPutMng_T {
    ...
    uint8_t ErrTempDown_opScaleRstTime;
    ...
    uint8_t ErrTempXhst_opScaleRstTime;
                                   // Mask Parameter: ErrTempXhst_opScaleRstTime
                                      //  Referenced by: '<S38>/SensErrorDetection'

    uint8_t ErrTempEvap_opScaleRstTime;
                                   // Mask Parameter: ErrTempEvap_opScaleRstTime
                                      //  Referenced by: '<S35>/SensErrorDetection'

    uint8_t ErrTempVent_opScaleRstTime;
                                   // Mask Parameter: ErrTempVent_opScaleRstTime
                                      //  Referenced by: '<S37>/SensErrorDetection'

    uint8_t ErrPresVent_opScaleRstTime;
    ...
    uint8_t ErrTempDown_opScaleSetTime;
    ...
    uint8_t ErrTempXhst_opScaleSetTime;
                                   // Mask Parameter: ErrTempXhst_opScaleSetTime
                                      //  Referenced by: '<S38>/SensErrorDetection'

    uint8_t ErrTempEvap_opScaleSetTime;
                                   // Mask Parameter: ErrTempEvap_opScaleSetTime
                                      //  Referenced by: '<S35>/SensErrorDetection'

    uint8_t ErrTempVent_opScaleSetTime;
                                   // Mask Parameter: ErrTempVent_opScaleSetTime
                                      //  Referenced by: '<S37>/SensErrorDetection'

    uint8_t ErrPresVent_opScaleSetTime;
    ...
    uint8_t ErrTempDown_staticRstTime;
    ...
    uint8_t ErrTempXhst_staticRstTime;
                                    // Mask Parameter: ErrTempXhst_staticRstTime
                                       //  Referenced by: '<S38>/SensErrorDetection'

    uint8_t ErrTempEvap_staticRstTime;
                                    // Mask Parameter: ErrTempEvap_staticRstTime
                                       //  Referenced by: '<S35>/SensErrorDetection'

    uint8_t ErrTempVent_staticRstTime;
                                    // Mask Parameter: ErrTempVent_staticRstTime
                                       //  Referenced by: '<S37>/SensErrorDetection'

    uint8_t ErrPresVent_staticRstTime;
    ...
    uint8_t ErrTempDown_staticSetTime;
    ...
    uint8_t ErrTempXhst_staticSetTime;
                                    // Mask Parameter: ErrTempXhst_staticSetTime
                                       //  Referenced by: '<S38>/SensErrorDetection'

    uint8_t ErrTempEvap_staticSetTime;
                                    // Mask Parameter: ErrTempEvap_staticSetTime
                                       //  Referenced by: '<S35>/SensErrorDetection'

    uint8_t ErrTempVent_staticSetTime;
                                    // Mask Parameter: ErrTempVent_staticSetTime
                                       //  Referenced by: '<S37>/SensErrorDetection'

    uint8_t ErrPresVent_staticSetTime;
    ...
    float const1_Value_f;              // Computed Parameter: const1_Value_f
                                          //  Referenced by: '<S14>/const1'

    float const2_Value_f;              // Computed Parameter: const2_Value_f
    ...
    float TmaxPrev_InitialCondition;
    ...
    float getTcap_Gain_o;              // Computed Parameter: getTcap_Gain_o
                                          //  Referenced by: '<S17>/getTcap'

    float Vnull2_Value_f;              // Computed Parameter: Vnull2_Value_f
                                          //  Referenced by: '<S17>/Vnull2'

    te_ctry inVentStopSys1_Value;      // Expression: te_ctry.Germany
                                          //  Referenced by: '<S3>/inVentStopSys1'

    te_heat_stt Constant1_Value;       // Expression: te_heat_stt.Heat_Heating
                                          //  Referenced by: '<S8>/Constant1'

    te_heat_stt Constant1_Value_p;     // Expression: te_heat_stt.Heat_Heating
                                          //  Referenced by: '<S13>/Constant1'

    te_heat_stt Constant3_Value;       // Expression: te_heat_stt.Heat_Heating
    ...
    te_tor_mode inSmartGrid_Value;     // Expression: te_tor_mode.tor_SmartGrid
                                          //  Referenced by: '<S3>/inSmartGrid'

    te_tor_mode inOffPeakHour_Value;  // Expression: te_tor_mode.tor_OffPeakHour
                                         //  Referenced by: '<S3>/inOffPeakHour'

    te_tor_mode inVentStopSys_Value;  // Expression: te_tor_mode.tor_VentSysStop
    ...
    ta_pwr ElecBoosterHeaterPower_Value;
  ...
  // model step function
  void step(const tb_InPutMng_In *rtu_InPutMng_In, tb_InPutMng_Out
            *rty_InPutMng_Out);
