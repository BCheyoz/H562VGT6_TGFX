...
GET_SET_CC_UINT16_PROTOTYPE(Bs_err_dtct_shnt_ena)
GET_SET_CC_UINT16_PROTOTYPE(Ss_ctry)
GET_SET_CC_UINT16_PROTOTYPE(Ss_tech_mode)
GET_SET_CC_UINT16_PROTOTYPE(Ns_anti_lgn_day)
GET_SET_CC_UINT16_PROTOTYPE(Ss_heat_pump_test_rqst)
GET_SET_CC_UINT16_PROTOTYPE(Ss_tank_size)
GET_SET_CC_UINT16_PROTOTYPE(Ss_sys_ver)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_pres_min)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_pres_sys)
GET_SET_CC_UINT16_PROTOTYPE(Ns_hldy_nb)
GET_SET_CC_UINT16_PROTOTYPE(Ns_pers_nb)
GET_SET_CC_UINT16_PROTOTYPE(Ss_user_mode)
GET_SET_CC_UINT16_PROTOTYPE(Ss_anti_lgn_ena)
GET_SET_CC_UINT16_PROTOTYPE(Ss_heat_wtr_cnsp_rst)
GET_SET_CC_UINT16_PROTOTYPE(Ss_vent_cnsp_rst)
GET_SET_CC_UINT16_PROTOTYPE(Ss_tot_cnsp_rst)
GET_SET_CC_UINT16_PROTOTYPE(Ss_sg_mode_ena)
GET_SET_CC_UINT16_PROTOTYPE(Ss_oph_mode_ena)
GET_SET_CC_UINT16_PROTOTYPE(Ss_hldy_rqst)
GET_SET_CC_UINT16_PROTOTYPE(Ss_bst_rqst)
GET_SET_CC_UINT16_PROTOTYPE(Cs_tank_down_temp_raw)
GET_SET_CC_UINT16_PROTOTYPE(Cs_tank_up_temp_raw)
GET_SET_CC_UINT16_PROTOTYPE(Cs_pump_xhst_temp_raw)
GET_SET_CC_UINT16_PROTOTYPE(Cs_pump_evap_temp_raw)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_temp_raw)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_pres_raw)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_rot_spd_raw)
GET_SET_CC_UINT16_PROTOTYPE(Cs_heat_pump_pwr)

GET_SET_CC_UINT16_PROTOTYPE(Cs_v40_lvl)
GET_SET_CC_UINT16_PROTOTYPE(Ss_op_mode)
GET_SET_CC_UINT16_PROTOTYPE(Ss_sg_stt)
GET_SET_CC_UINT16_PROTOTYPE(Ss_oph_stt)
GET_SET_CC_UINT16_PROTOTYPE(Cs_tank_down_temp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_tank_up_temp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_pump_xhst_temp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_pump_evap_temp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_temp)
GET_SET_CC_UINT16_PROTOTYPE(Ss_elec_bstr_htr_sp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_heat_pump_rot_spd_sp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_rot_spd)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_cnsp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_heat_wtr_cnsp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_tot_cnsp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_v40_sp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_temp_sp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_pres_sp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_flow_sp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_vltg_sp)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_pres)
GET_SET_CC_UINT16_PROTOTYPE(Cs_pres_mes_filt)
GET_SET_CC_UINT16_PROTOTYPE(Cs_vent_pwr)
