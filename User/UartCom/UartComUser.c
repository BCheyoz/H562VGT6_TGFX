...
#if defined(NB_EMBRACO_INVERTER_BUF_DEF_SIZE) && (NB_EMBRACO_INVERTER_BUF_DEF_SIZE > 0)	// cf. "EmbracoInverterConf.h"
	{ UART_COM_INVERTER,	EMBRACO_INVERTER_TX_REGULAR_FN,		EMBRACO_INVERTER_TX_REGULAR_PARAM,	EMBRACO_INVERTER_TX_FIRST_DELAY, EMBRACO_INVERTER_TX_NORMAL_DELAY, EMBRACO_INVERTER_TX_DEF_FRAME_SIZE },
#endif // NB_EMBRACO_INVERTER_BUF_DEF_SIZE
