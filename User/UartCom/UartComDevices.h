...
// ...
#define UART_COM_NB_OF_UART_MODBUS_SLAVE_ONLY	3	// UART2 -> ModbusSlave IHM, UART3 -> ModbusSlave User, UART8 -> ModbusSlave Ext (small)
#define UART_COM_NB_OF_UART_MODBUS_SLAVE_FTFL	0	// 0 car Alternance (= Fitful) avec un autre Protocole non prévu
// ...
#define UART_COM_NB_OF_UART_MODBUS_MASTER_ONLY	0	// 0 car Non prévu
