...
// ...
#define UART_COM_NB_OF_UART_BLE_SLAVE_ONLY		1	// UART4 -> Bluetooth User
// ...
...
#define COM_UART_BLE_SRC_ID				9	// Source = Uart4
...
#define COM_SPECIAL_BLE_SRC_FLAG 		(1 << COM_UART_BLE_SRC_ID) 			// Source = Uart4

/******************************************************************************/

// Synthèse des usages prévus par Périphérique (ne pas modifer) :
#define UART_COM_NB_OF_UARTS_USED				(UART_COM_NB_OF_UART_CHANGEABLE_USAGE + UART_COM_NB_OF_UART_IBUS_ONLY + UART_COM_NB_OF_UART_MODBUS_SLAVE_ONLY + UART_COM_NB_OF_UART_MODBUS_MASTER_ONLY + UART_COM_NB_OF_UART_BLE_SLAVE_ONLY)
