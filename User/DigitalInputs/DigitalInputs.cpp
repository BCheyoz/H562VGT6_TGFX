...
void DigitalInputs::GestionDigitalInputs()
{
	...
	//	}
		...
		if(input->_newStateEvent)
		{
			...
			if(0 != pFn) pFn(DI_EVENT_NEW_STATE);
		...
		if(input->_newWorkEvent)
		{
			...
			if(0 != pFn) pFn(DI_EVENT_NEW_WORK_STATE);
		...
		if(input->_newIdleEvent)
		{
			...
			if(0 != pFn) pFn(DI_EVENT_NEW_IDLE_STATE);
		...
		if(input->_newWork1sEvent)
		{
			...
			if(0 != pFn) pFn(DI_EVENT_WORK_STATE_1S);
		...
		if(input->_newIdle1sEvent)
		{
			...
			if(0 != pFn) pFn(DI_EVENT_IDLE_STATE_1S);
		...
		if(input->_newWork3sEvent)
		{
			...
			if(0 != pFn) pFn(DI_EVENT_WORK_STATE_3S);
		...
		if(input->_newIdle3sEvent)
		{
			...
			if(0 != pFn) pFn(DI_EVENT_IDLE_STATE_3S);
		...
		if(input->_newWork10sEvent)
		{
			...
			if(0 != pFn) pFn(DI_EVENT_WORK_STATE_10S);
		...
		if(input->_newIdle10sEvent)
		{
			...
			if(0 != pFn) pFn(DI_EVENT_IDLE_STATE_10S);
		...
		if(input->_newAutoFireEvent)
		{
			...
			if(0 != pFn) pFn(DI_EVENT_AUTO_FIRE);
