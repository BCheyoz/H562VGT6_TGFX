...
KEEP extern const touchgfx::KerningNode kerning_HelveticaLinotype_Regular_40_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x0047, -3 },  // (First char = [0x0047, G], Second char = [0x0056, V], Kerning dist = -3)
    ...
    { 0x0047, -2 },  // (First char = [0x0047, G], Second char = [0x0057, W], Kerning dist = -2)
    ...
    { 0x0020, -4 },  // (First char = [0x0020, space], Second char = [0x0059, Y], Kerning dist = -4)
    ...
    { 0x0047, -3 },  // (First char = [0x0047, G], Second char = [0x0059, Y], Kerning dist = -3)
