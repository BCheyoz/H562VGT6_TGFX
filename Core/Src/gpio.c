...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, AFF_D_C_Pin|GPIO_PIN_15|GPIO_PIN_0, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PEPin PE15 PE0 */
  GPIO_InitStruct.Pin = AFF_D_C_Pin|GPIO_PIN_15|GPIO_PIN_0;
