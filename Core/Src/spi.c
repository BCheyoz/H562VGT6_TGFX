...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  */
    ...
    PB15     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = BLE_SPI_CS_Pin|BLE_SPI_SCK_Pin|BLE_SPI_MISO_Pin|BLE_SPI_MOSI_Pin;
  ...
  */
    ...
    PE6     ------> SPI4_MOSI
    */
    GPIO_InitStruct.Pin = AFF_SPI4_SCK_Pin|AFF_SPI4_CS_Pin|AFF_SPI4_SDO_Pin|AFF_SPI4_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, BLE_SPI_CS_Pin|BLE_SPI_SCK_Pin|BLE_SPI_MISO_Pin|BLE_SPI_MOSI_Pin);
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE6     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, AFF_SPI4_SCK_Pin|AFF_SPI4_CS_Pin|AFF_SPI4_SDO_Pin|AFF_SPI4_SDA_Pin);
